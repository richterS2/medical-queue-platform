...
public class PrintDirectActivity extends AppCompatActivity {
    ...
    private void getData() {
        ...
        final ProgressDialog pd = ProgressDialog.show(PrintDirectActivity.this, "",
                "Buscando...", true);

        RequestQueue queue = Volley.newRequestQueue(PrintDirectActivity.this);
    ...
    private void doPrint() {
        ...
        printManager.print(jobName, new MyPrintDocumentAdapter(PrintDirectActivity.this),
                null);
    }
    ...
    private void getMedicalPwdPrint(String url) {
        ...
        final ProgressDialog pd = ProgressDialog.show(PrintDirectActivity.this, "", "Buscando...", true);
    ...
    private Context getActivity() {
        return PrintDirectActivity.this;
    }
